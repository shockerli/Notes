...
/* 网络函数 */
checkdnsrr($host [,$type = "MX" ]) //给指定的主机（域名）或者IP地址做DNS通信检查
dns_get_record($host [,$type = DNS_ANY [,&$authns [,&$addtl [,&$raw = false]]]]) //获取指定主机的DNS记录
gethostbyaddr($ip_address) //获取指定的IP地址对应的主机名
...
1. array_walk不支持闭包函数，支持对象方法/静态方法
   array_map
