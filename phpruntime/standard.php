 ...
 * @link http://php.net/manual/zh/function.getimagesizefromstring.php
 ...
 * 如果文件名是以suffix结束的，那这一部分也会被去掉。
 * </p>
 * @return <i>path</i>的基本文件名
 */
 ...
 * 如果没有指定options默认是返回全部的单元。
 * </p>
 * @return mixed 如果没有传入options，将会返回包括以下单元的数组：dirname，basename，extension（如果有）以及filename。
 * </p>
 * <p>
 ...
 * @link http://php.net/manual/zh/function.password-hash.php
 ...
 * @link http://php.net/manual/zh/function.password-get-info.php
 * @param string $hash <p>
 ...
 * @link http://php.net/manual/zh/function.password-needs-rehash.php
 * @param string $hash <p>
 * A hash created by <b>password_hash</b>.
 * </p>
 * @param string $algo <p>
 ...
 * @link http://php.net/manual/zh/function.password-verify.php
 * @param string $password <p>
 * The user&#x00027;s password.
 * </p>
 * @param string $hash <p>
 ...
 * @link http://php.net/manual/zh/function.header-register-callback.php
 ...
 * @link http://php.net/manual/zh/function.http-response-code.php
 ...
 * @link http://php.net/manual/zh/function.stream-set-chunk-size.php
 * @param resource $fp <p>
 * The target stream.
 * </p>
 ...
 * @link http://php.net/manual/zh/function.key-exists.php
 * @param $key
 * @param $search
 */
 ...
 * @link http://php.net/manual/zh/password.constants.php
 */
 ...
 * @link http://php.net/manual/zh/dir.constants.php
 */
