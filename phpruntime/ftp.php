 ...
 * @param string $host <p>
 * 规定要连接的FTP服务器。可以是域名或IP地址。后面不应以斜线结尾，前面也不需要用ftp://开头。
 * </p>
 * @param int $port [optional] <p>
 * 要连接到的FTP器的端口号，如果没有设置或者为0，则会使用默认的端口21来连接。
 * </p>
 * @param int $timeout [optional] <p>
 * 网络传输的超时时间限制。如果此选项留空，则默认的值为90秒。超时时间可以在任何时候通过函数ftp_set_option()及ftp_get_option()来改变和获取。
 * </p>
 * @return resource 若成功则返回一个连接标识，否则返回false。
 */
 ...
 * 密码
 * </p>
 * @return bool 成功时返回TRUE，或者在失败时返回FALSE。如果登录失败，PHP会抛出一个警告。
 */
 ...
 * FTP连接的链接标识符
 * </p>
 * @return string 返回当前目录名称，发生错误则返回FALSE
 */
